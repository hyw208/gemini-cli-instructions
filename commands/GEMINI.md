...
This document provides instructions for the custom commands available in this project. These commands are under ./commands folder where there are multiple *.toml files containing explicit instructions on how to use/invoke/execute them.

| Command      | Description                                                 | Usage                                                              | Run |
|--------------|-------------------------------------------------------------|--------------------------------------------------------------------|------|
